...
const Footer = () => {
    return (
        <div className='w-full h-screen p-16 flex gap-4' >
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div className="heading text-8xl leading-none tracking-tighter font-bold
                ">
                    <h1>EYE-</h1>
                    <h1>OPENING</h1>
                </div>
            ...
            <div className='w-1/2'>
                ...
                ">
                    ...
                    <div className='links pt-10'>
                        <p className='text-xl text-zinc-600 pb-6'>S :</p>
                        {["Instagram", "Behance", "Facebook", "Insights", "Dribble"].map((item, index) => (
                            <a key={index} className={`text-xl font-semibold text-zinc-600 block capitalize tracking-tighter`}>{item}</a>
                        ))}
                    </div>
                    <div className='flex flex-row justify-between'>
                        <div className='links pt-10'>
                            <p className='text-xl text-zinc-600 pb-6'>M :</p>
                            {["Instagram", "Behance", "Facebook", "Insights"].map((item, index) => (
                                <a key={index} className={`text-xl font-semibold text-zinc-600 block capitalize tracking-tighter`}>{item}</a>
                            ))}
                        </div>
                        <div className='links pt-10'>
                            <p className='text-xl text-zinc-600 pb-6'>L :</p>
                            {["Instagram", "Behance", "Facebook", "Insights"].map((item, index) => (
                                <a key={index} className={`text-xl font-semibold text-zinc-600 block capitalize tracking-tighter`}>{item}</a>
                            ))}
                        </div>
                    ...
                    <div className='pt-5'>
                        <p className='text-xl text-zinc-600 pb-2'>E :</p>
                        <a className='text-xl font-semibold text-zinc-600 block tracking-tighter'>hello@ochi.design</a>
                    </div>
                </div>
            </div>
        </div>
